...
Harcadium gear is the "Great Equalizer." It is the minimum requirement for engaging any Titan below **Greater** status. Without this equipment, most Titans will ignore your attacks entirely.

---

## ⚔️ Harcadium Tools
All Harcadium tools feature **Armor Piercing** capabilities, allowing them to bypass the natural defenses of Giant Creatures.

| Tool | Normal Damage | Giant Damage (Piercing) | Unique Abilities |
| :--- | :--- | :--- | :--- |
| **Sword** | 50 | 500 | Standard Anti-Titan weapon. |
| **Axe** | 49 | 450 | Super-fast wood chopping. |
| **Pickaxe** | 48 | 400 | Mines Obsidian in ~2 seconds. |
| **Shovel** | 47 | 350 | Elite excavation speed. |
| **Hoe** | N/A | 300 | Tills gravel, mycelium, and dry sponge into farmland. |

### 🏹 The Harcadium Bow & Arrows
Considered "Powerful as S$!&," this bow is a mandatory tool for keeping distance during Titan fights.

* **Armor Piercing:** Deals **500 damage** to Giant Creatures.
* **Anti-Wither:** Completely ignores the Wither's special armored phase.
* **Recovery:** Arrows can be retrieved even if they hit an entity.
* **Requirement:** Requires **Diamond String** to craft.

---

## 🛡️ Harcadium Armor
Crafted like standard armor but using Harcadium ingots. Each piece provides god-like status effects to the wearer.

### Individual Piece Buffs
* **Helmet:** Night Vision, Water Breathing.
* **Chestplate:** Haste IV, Resistance IV, Strength X, Fire Resistance.
* **Leggings:** Regeneration V.
* **Boots:** Jump Boost II, Speed IV.

### 💎 Full Set Bonuses
When the complete set is worn, the player gains the following:
* **Absorption XL:** Massive extra health that replenishes every 40 seconds.
* **Saturation XX:** You will never need to eat again.
* **Aura:** The wearer gives off a quiet, powerful hum.

!!! danger "Combat Threshold"
